...
class _MapboxSource implements MapboxSource {
  _MapboxSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<SuggestionResponse> getSuggestedPlaces(
    ...
    late SuggestionResponse _value;
    try {
      _value = SuggestionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
